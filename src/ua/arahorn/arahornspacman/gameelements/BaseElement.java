...
//		if(rotate == 270) {
//			gl.glTranslatef(positionX, positionY + sizeInSurface, 0f);
//			gl.glRotatef(rotate, 0.0f, 0.0f, 1.0f);
////			gl.glTranslatef(-positionX , -positionY , 0f);
//		} else if(rotate == 180) {
//			gl.glTranslatef(positionX + sizeInSurface, positionY + sizeInSurface, 0f);
//			gl.glRotatef(rotate, 0.0f, 0.0f, 1.0f);
//		} else if(rotate == 90) {
//			gl.glTranslatef(positionX + sizeInSurface, positionY, 0f);
//			gl.glRotatef(rotate, 0.0f, 0.0f, 1.0f);			
//		} else
//			gl.glTranslatef(positionX , positionY , 0f);
		...
		float texture[] = {
				...
				(elementSize * (numberInAtlas % 8) + 2)/512f,				(elementSize * (numberInAtlas / 8) + elementSize - 2)/512f,     // top left     (V2)
				(elementSize * (numberInAtlas % 8) + 2)/512f, 				(elementSize * (numberInAtlas / 8) + 2)/512f,     // bottom left  (V1)
		        (elementSize * (numberInAtlas % 8) + elementSize - 2)/512f, (elementSize * (numberInAtlas / 8) + elementSize - 2)/512f,     // top right    (V4)
		        (elementSize * (numberInAtlas % 8) + elementSize - 2)/512f, (elementSize * (numberInAtlas / 8) + 2)/512f      // bottom right (V3)
		};
